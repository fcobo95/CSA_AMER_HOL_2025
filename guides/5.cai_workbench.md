...
### 0 Deploy `Churn Modeling with scikit-learn` AMP
The lab starts with an existing AMP, `Churn Modeling with scikit-learn`.
1. Open Cloudera AI workbench. 
1. From the nevigation side bar, select `AMPs`.
1. In `Search AMPs`, paste `Churn`, and locate the AMP `Churn Modeling with scikit-learn`.
1. Click `Deploy`, and click `Configure & Deploy`
![Deploy AMP](./guide_images/5.cai_workbench/deploy_amp1.png)

e. Leave the parameters as is and change below parameters, and then `Launch Project`
  Kernel: Python 3.9
  Version: 2025.01
  Enable Spark
![Deploy AMP](./guide_images/5.cai_workbench/deploy_amp2.png)

It will take a while for the AMP to be deployed.

f. After the project is deployed, go to the `All Projects` -> <Your project> -> `Project Settings` -> `Runtimes` to add a JupyterLab runtime. 
![Add Runtime](./guide_images/5.cai_workbench/add_runtime.png)
...
![data](./guide_images/5.cai_workbench/data.png)
...
![disable_auth](./guide_images/5.cai_workbench/disable_auth.png)
...
![table_view](./guide_images/5.cai_workbench/table_view.png)
...
![single_view_1](./guide_images/5.cai_workbench/single_view_1.png)
...
![single_view_2](./guide_images/5.cai_workbench/single_view_2.png)
...
![model_id](./guide_images/5.cai_workbench/model_id.png)
...
![model_accuracy](./guide_images/5.cai_workbench/model_accuracy.png)
