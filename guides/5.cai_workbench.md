...
a. Open Cloudera AI workbench. 
b. From the nevigation side bar, select `AMPs`.
c. In `Search AMPs`, paste `Churn`, and locate the AMP `Churn Modeling with scikit-learn`.
d. Click `Deploy`, and click `Configure & Deploy`
